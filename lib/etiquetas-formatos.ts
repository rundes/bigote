/**
 * Especificaciones de las etiquetas. Sin `qrcode` a propósito: el selector es un
 * componente cliente y no debe arrastrar la librería de generación al bundle.
 *
 * Hoja A4 (210 × 297 mm) con margen de 10 mm, útil 190 × 277 mm. Papel común: se
 * imprime, se corta y el pegamento lo pone quien etiqueta.
 */
